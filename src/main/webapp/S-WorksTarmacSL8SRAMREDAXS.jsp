...
<head>
    ...
    <title>S-Works Tarmac SL8 – SRAM RED AXS</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.5/font/bootstrap-icons.css">

    <link rel="website icon" type="jpg" href="../images/img21.jpg" width="200px" height="200px">
...
/*CSSS PARA LA PARTE DE LAS ESTRELLAS*/
.stars {
    color: gold;
    font-size: 1.2em;
  }
  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS /  <span>S-Works Tarmac SL8 – SRAM RED AXS</span>
        </h4>
      </div>
      <br><br>
      ...
      <div class="banner-contenedor">
        <div class="banner-centered">
            ...
            <img src="images/img21.jpg" alt="Paginas S-Works" title="S-Works Tarmac SL8 – SRAM RED AXS">
            <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
          </div>
        <div class="descripcion-banner">
          <h2>S-Works Tarmac SL8 – SRAM RED AXS</h2>
          <p> Nada es mas rapido que la Tarmac SL8 gracias a una combinacion de aerodinamica; ligereza y calidad de conduccion que antes se creia imposible. Tras ocho generaciones y mas de dos decadas de desarrollo, es mas que la Tarmac mas rapida de la historia: es la bicicleta de carreras mas rapida del mundo. La aerodinamica o la ligereza por si solas no ganan carreras: la velocidad es lo que importa.</p>
          <p class="precio">$55,650.00 <span>(Impuesto incluido)</span></p>
...
<form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="S-Works Tarmac SL8 – SRAM RED AXS">
  <input type="hidden" name="imagen" value="images/img21.jpg">
  <input type="hidden" name="precio" value="55,650.00">
   <input type="hidden" name="talla" value="M">
   <input type="hidden" name="producto" value="Bicicleta Ruta SL8">
