...
<br>
      ...
      <div class="banner">
        <img class="banner" src="images/bannermujer.jpg">
      </div>
...
<div class="banner-centered">
    <img src="images/Maillot de Manga Corta Prime de Mujer.jpg" alt="Maillot de Manga Corta Prime de Mujer" title="Maillot de Manga Corta Prime de Mujer" style="width: 100%;">
    <div class="descripcion-banner">
        <div>
            <h2>Maillot de Manga Corta Prime de Mujer</h2>
            <div class="etiqueta-talla">M</div>
            <p class="precio">$380.00</p>
            <p><span class="stars">★★★★</span></p>
        </div>
        <form action="Carrito.jsp" method="post">
            <input type="hidden" name="nombre" value="Maillot de Manga Corta Prime de Mujer">
            <input type="hidden" name="imagen" value="images/Maillot de Manga Corta Prime de Mujer.jpg">
            <input type="hidden" name="precio" value="380.00">
		 <input type="hidden" name="talla" value="M">
    <input type="hidden" name="producto" value="Jerseys Mujer">
    ...
    <div class="banner-centered">
        <img src="images/Maillot de manga larga Air Trail Mujer.jpg" alt="Maillot de manga larga Air Trail Mujer" title="Maillot de manga larga Air Trail Mujer">
        <div class="descripcion-banner">
            <h2>Maillot de manga larga Air Trail Mujer</h2>
                <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
            <p class="precio">$335.00 </p>
                <P> <span class="stars">★★★★</span></P><br>
            <form action="Carrito.jsp" method="post">
            <input type="hidden" name="nombre" value="Maillot de manga larga Air Trail Mujer">
            <input type="hidden" name="imagen" value="images/Maillot de manga larga Air Trail Mujer.jpg">
    ...
    <div class="banner-centered">
        <img src="images/Maillot de manga corta de Women's.jpg" alt="Maillot de manga corta de Women'sr" title="Maillot de manga corta de Women's">
        <div class="descripcion-banner">
            <h2>Maillot de manga corta de Women's</h2>
                <div class="etiqueta-talla">S</div> <!-- Talla M como etiqueta -->
            <p class="precio">$180.00 </p>
                <P> <span class="stars">★★★★</span></P><br>
                      <form action="Carrito.jsp" method="post">
            <input type="hidden" name="nombre" value="Maillot de manga corta de Women's">
            <input type="hidden" name="imagen" value="images/Maillot de manga corta de Women's.jpg">
    ...
    <div class="banner-centered">
        <img src="images/Maillot de manga larga de trail para mujer.jpg" alt="Maillot de manga larga de trail para mujer" title="Maillot de manga larga de trail para mujer">
        <div class="descripcion-banner">
            <h2>Maillot de manga larga de trail para mujer</h2>
                <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
            <p class="precio">$160.00 </p>
                <P> <span class="stars">★★★★</span></P>
                      <form action="Carrito.jsp" method="post">
            <input type="hidden" name="nombre" value="Maillot de manga larga de trail para mujer">
            <input type="hidden" name="imagen" value="images/Maillot de manga larga de trail para mujer.jpg">
    ...
    <div class="banner-centered">
        <img src="images/Maillot de manga corta de trail para mujer.jpg" alt="Maillot de manga corta de trail para mujer" title="Maillot de manga corta de trail para mujer">
        <div class="descripcion-banner">
            <h2>Maillot de manga corta de trail para mujer</h2>
                <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
            <p class="precio">$135.00 </p>
                <P> <span class="stars">★★★★</span></P>
                    <form action="Carrito.jsp" method="post">
            <input type="hidden" name="nombre" value="Maillot de manga corta de trail para mujer">
            <input type="hidden" name="imagen" value="images/Maillot de manga corta de trail para mujer.jpg">
    ...
    <div class="banner-centered">
        <img src="images/ADV Air Jersey para mujer.jpg" alt="ADV Air Jersey para mujer" title="ADV Air Jersey para mujer">
        <div class="descripcion-banner">
            <h2>ADV Air Jersey para Mujer</h2>
                <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
            <p class="precio">$105.00 </p>
                <P> <span class="stars">★★★★</span></P><br>
                     <form action="Carrito.jsp" method="post">
            <input type="hidden" name="nombre" value="ADV Air Jersey para Mujer">
            <input type="hidden" name="imagen" value="images/ADV Air Jersey para mujer.jpg">
    ...
    <div class="banner-centered">
        <img src="images/Women's RBX Classic Short Sleeve Jersey.jpg" alt="Women's RBX Classic Short Sleeve Jersey" title="Women's RBX Classic Short Sleeve Jersey">
        <div class="descripcion-banner">
            <h2>Women's RBX Classic Short Sleeve Jersey</h2>
                <div class="etiqueta-talla">S</div> <!-- Talla M como etiqueta -->
            <p class="precio">$100.00 </p>
                <P> <span class="stars">★★★★</span></P><br>
                     <form action="Carrito.jsp" method="post">
            <input type="hidden" name="nombre" value="Women's RBX Classic Short Sleeve Jersey">
            <input type="hidden" name="imagen" value="images/Women's RBX Classic Short Sleeve Jersey.jpg">
