...
<head>
    ...
    <title>S-Works Epic World Cup</title>
  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS /  <span>S-Works Epic World Cup</span>
        </h4>
      </div>
      <br><br>
      ...
      <div class="banner-contenedor">
        <div class="banner-centered">
            <img src="images/img16.jpg" alt="Paginas S-Works" title="S-Works Epic World Cup">
            <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
          </div>
        <div class="descripcion-banner">
          <h2>S-Works Epic World Cup</h2>
          <p>PIENSA MAS RAPIDO: La Epic World Cup es la bicicleta de carreras XC mas rapida del mundo en recorridos suaves 
            a tecnicos gracias a su inigualable combinacion de eficiencia, control y ligereza. El campeon del mundo Christopher
             Blevins lo expreso asi: "Esta bici me da todo lo que podria desear de una bicicleta rigida; ademas del control y la
              capacidad de la doble suspension". Todo lo que se necesito para crear esta maquina de competicion. 
          </p>
          <p class="precio">$51,940.00 <span>(Impuesto incluido)</span></p>
          <p class="precio">
            🚨Última unidad🚨  
...
<form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="S-Works Epic World Cup">
  ...
  <input type="hidden" name="precio" value="51,940.00 ">
   ...
   <input type="hidden" name="producto" value="Bicicleta MTB World Cup">
