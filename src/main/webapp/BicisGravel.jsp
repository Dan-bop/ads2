  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS / <span>Bicis Gravel</span>
        </h4>
      </div>
<br>

      <div class="banner">
        <img class="banner" src="images/img10.jpg">
      </div>
...
<div class="banner-contenedor">
    <div class="banner-centered">
        <img src="images/Diverge STR Pro.jpg" alt="Diverge STR Pro" title="Diverge STR Pro">
           <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Diverge STR Pro</h2>
            <p class="precio">$35,990.00 </p>
                <p> <span class="stars">★★★★</span></p><br>
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Diverge STR Pro">
  <input type="hidden" name="imagen" value="images/Diverge STR Pro.jpg">
  <input type="hidden" name="precio" value="35,990.00">
   <input type="hidden" name="talla" value="L">
   <input type="hidden" name="producto" value="Bicicleta de Ruta">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Diverge STR Expert.jpg" alt="Diverge STR Expert" title="Diverge STR Expert">
           <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Diverge STR Expert</h2>
            <p class="precio">$ 27,825.00 </p>
                <P> <span class="stars">★★★★</span></P><br>
       <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Diverge STR Expert">
  <input type="hidden" name="imagen" value="images/Diverge STR Expert.jpg">
  <input type="hidden" name="precio" value="27,825.00 ">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Diverge STR Expertnegro.jpg" alt="Diverge STR Expert" title="Diverge STR Expert">
           <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Diverge STR Expert</h2>
            <p class="precio">$ 27,825.00 </p>
            ...
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Diverge STR Expert">
  <input type="hidden" name="imagen" value="images/Diverge STR Expertnegro.jpg">
  <input type="hidden" name="precio" value="27,825.00 ">
   <input type="hidden" name="talla" value="L">
     <input type="hidden" name="producto" value="Bicicleta de Ruta">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Diverge Expert Carbon.jpg" alt="Diverge Expert Carbon" title="Diverge Expert Carbon">
           <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Diverge Expert Carbon</h2>
            <p class="precio">$ 25,230.00</p>
                <P> <span class="stars">★★★★</span></P>
             <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Diverge Expert Carbon">
  <input type="hidden" name="imagen" value="images/Diverge Expert Carbon.jpg">
  <input type="hidden" name="precio" value="25,230.00">
   <input type="hidden" name="talla" value="M">
     <input type="hidden" name="producto" value="Bicicleta de Ruta">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Diverge Expert Carbonazul.jpg" alt="Diverge Expert Carbon" title="Diverge Expert Carbon">
        ...
        <div class="descripcion-banner">
            ...
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Diverge Expert Carbon">
  <input type="hidden" name="imagen" value="images/Diverge Expert Carbonazul.jpg">
  <input type="hidden" name="precio" value="25,230.00">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Crux Expert.jpg" alt="Crux Expert" title="Crux Expert">
           <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Crux Expert</h2>
            <p class="precio">$ 24,115.00</p>
                <P> <span class="stars">★★★★</span></P><br>
               <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Crux Expert">
  <input type="hidden" name="imagen" value="images/Crux Expert.jpg">
  <input type="hidden" name="precio" value="24,115.00">
   <input type="hidden" name="talla" value="L">
     <input type="hidden" name="producto" value="Bicicleta de Ruta">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Diverge Comp Carbon.jpg" alt="Diverge Comp Carbon" title="Diverge Comp Carbon">
           <div class="etiqueta-talla">XS</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Diverge Comp Carbon</h2>
            <p class="precio">$  17,070.00</p>
                <P> <span class="stars">★★★★</span></P><br>
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Diverge Comp Carbon">
  <input type="hidden" name="imagen" value="images/Diverge Comp Carbon.jpg">
  <input type="hidden" name="precio" value=" 17,070.00">
   <input type="hidden" name="talla" value="XS">
     <input type="hidden" name="producto" value="Bicicleta de Ruta">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Diverge E5.jpg" alt="Diverge E5" title="Diverge E5">
           <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Diverge E5</h2>
            <p class="precio">$  5,565.00</p>
                <P> <span class="stars">★★★★</span></P><br>
          <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Diverge E5">
  <input type="hidden" name="imagen" value="images/Diverge E5.jpg">
  <input type="hidden" name="precio" value="  5,565.00">
   <input type="hidden" name="talla" value="l">
     <input type="hidden" name="producto" value="Bicicleta de Ruta">
  <input type="hidden" name="cantidad" value="1">
