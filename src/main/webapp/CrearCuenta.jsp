...
<div style="text-align: center;">
  <div class="cuenta-form-container">
   ...
   <h3 class="titulo-principal" style="text-align: center;">Crear Cuenta</h3>
<h4 class="subtitulo" style="text-align: center;">Ingrese su información a continuación para continuar. Si ya tiene una cuenta, inicie sesión en su lugar.</h4>

    <br>
    
    	<div class="mb-3">
    		<label for="nombre" class="form-label">Nombre:</label>
    		<input type="text" name="nombre" class="form-control" id="nombre" maxlength="40" required placeholder="Ingresar Nombre">
    		</div>
    		
    	<div class="mb-3">
    		<label for="apellido" class="form-label">Apellido:</label>	
    			<input type="text" name="apellido" class="form-control" id="apellido" maxlength="40" required placeholder="Ingresar Apellido">
    	</div>
      ...
      <!-- CODIGO DE  SOBRE TERMINOS Y CONDICIONES -->
<div class="mb-3" style="text-align: left;">
  <label style="font-family: 'Poppins', sans-serif; font-size: 0.9rem; cursor: pointer;">
    <input type="checkbox" style="margin-right: 8px;">
    Estoy de acuerdo con los <a href="TerminoCondiciones.jsp" style="color:#007bff; text-decoration: underline;">Términos y Condiciones</a> y la <a href="#" style="color:#007bff; text-decoration: underline;">Política de Tratamiento de Datos Personales</a>.
  </label>
</div>
   ...
   <button class="btn cuenta-btn-submit">Crear Cuenta</button>
  ...
  <h4 style="margin: 0; font-family: 'Poppins', sans-serif; font-weight: 400;">Ya tiene una Cuenta?</h4>
  <a href="login.jsp" style="font-family: 'Poppins', sans-serif; font-weight: 600; font-size: 1.1rem; text-decoration: none; color: #007bff;">
    Iniciar Sesión
  </a>
</div>
