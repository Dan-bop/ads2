...
<head>
    ...
    <title>S-Works Stumpjumper EVO</title>
  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS /  <span>S-Works Stumpjumper EVO</span>
        </h4>
      </div>
      <br><br>
      ...
      <div class="banner-contenedor">
        <div class="banner-centered">
            ...
            <img src="images/img19.jpg" alt="Paginas S-Works" title="S-Works Stumpjumper EVO">
            <div class="etiqueta-talla">S</div> <!-- Talla M como etiqueta -->
          </div>
        <div class="descripcion-banner">
          <h2>S-Works Stumpjumper EVO</h2>
          <p>La S-Works Stumpjumper EVO es mucho más que una simple bicicleta de trail; es una bicicleta todoterreno diseñada para dominar los senderos más difíciles. Con un diseño completamente nuevo, ángulo de tubo de dirección ajustable, 150 mm de recorrido optimizado para el rendimiento y la adaptabilidad de la talla S.</p>
          <p class="precio">$20,922.00 <span>(Impuesto incluido)</span></p>
...
<form action="Carrito.jsp" method="post">
  ...
  <input type="hidden" name="precio" value="20,922.00">
   ...
   <input type="hidden" name="producto" value="Bicicleta MTB EVO">
