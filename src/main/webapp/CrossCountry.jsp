  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS / <span>Cross Country</span>
        </h4>
      </div>
<br>

      <div class="banner">
        <img class="banner" src="images/bannerCrossCountry.jpg">
      </div>
...
<div class="banner-contenedor">
    <div class="banner-centered">
        <img src="images/img22.jpg" alt="S-WORKS EPIC 8" title="S-WORKS EPIC 8">
          <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>S-WORKS EPIC 8</h2>
            <p class="precio">$59,360.00 </p>
                <P> <span class="stars">★★★★</span></P>
                
           <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="S-WORKS EPIC 8">
  <input type="hidden" name="imagen" value="images/img22.jpg">
  <input type="hidden" name="precio" value="59,360.00">
   <input type="hidden" name="talla" value="M">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  ...
  <center>
    ...
    <div class="banner-centered">
         <img src="images/Epic 8 EVO Pro.jpg" alt="Epic 8 EVO Pro" title="Epic 8 EVO Pro">
           <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Epic 8 EVO Pro</h2>
            <p class="precio">$36,360.00 </p>
                <P> <span class="stars">★★★★</span></P>
                
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Epic 8 EVO Pro">
  <input type="hidden" name="imagen" value="images/Epic 8 EVO Pro.jpg">
  <input type="hidden" name="precio" value="36,360.00">
   <input type="hidden" name="talla" value="M">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    <button type="submit">Agregar<span></span></button>
      ...
      <div class="banner-centered">
         <img src="images/Epic 8 Pro.jpg" alt="Epic 8  Pro" title="Epic 8  Pro">
           <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Epic 8  Pro</h2>
            <p class="precio">$36,360.00 </p>
                <P> <span class="stars">★★★★★</span></P>
                      ...
                      <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Epic 8  Pro">
  <input type="hidden" name="imagen" value="images/Epic 8 Pro.jpg">
  <input type="hidden" name="precio" value="36,360.00">
   <input type="hidden" name="talla" value="L">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    <button type="submit">Agregar<span></span></button>
      ...
      <div class="banner-centered">
         <img src="images/Chisel.jpg" alt="Chisel" title="Chisel">
           <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Chisel</h2>
            <p class="precio">$10,768.00 </p>
                <P> <span class="stars">★★★★★</span></P>
                
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Chisel">
  <input type="hidden" name="imagen" value="images/Chisel.jpg">
  <input type="hidden" name="precio" value="10,768.00">
   <input type="hidden" name="talla" value="M">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    <button type="submit">Agregar<span></span></button>
      ...
      <div class="banner-centered">
         <img src="images/Rockhopper Sport 29.jpg" alt="Rockhopper Sport 29" title="Rockhopper Sport 29">
           <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Rockhopper Sport 29</h2>
            <p class="precio">$2,900.00 </p>
               <P> <span class="stars">★★★★★</span></P>
                  <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Chisel">
  <input type="hidden" name="imagen" value="images/Rockhopper Sport 29.jpg">
  <input type="hidden" name="precio" value="2,900.00">
   <input type="hidden" name="talla" value="M">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  <input type="hidden" name="cantidad" value="1">
  ...
  <div class="banner-centered">
         <img src="images/img15.jpg" alt="S-Works Stumpjumper 15 LTD" title="S-Works Stumpjumper 15 LTD">
           <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>S-Works Stumpjum</h2>
            <p class="precio">$19,900.00 </p>
               <P> <span class="stars">★★★★★</span></P>
                             <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="S-Works Stumpjum">
  <input type="hidden" name="imagen" value="images/img15.jpg">
  <input type="hidden" name="precio" value="19,900.00">
   <input type="hidden" name="talla" value="L">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  <input type="hidden" name="cantidad" value="1">
