  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS / <span>S-WORKS EPIC 8</span>
        </h4>
      </div>
      <br><br>
      ...
      <div class="banner-contenedor">
        <div class="banner-centered">
            <img src="images/swor.jpg" alt="Paginas S-Works" title="S-WORKS Epic 8">
            <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
          </div>
        <div class="descripcion-banner">
          <h2>S-WORKS EPIC 8</h2>
          <p>La nueva EPIC 8 evoluciona la fórmula de maxima velocidad, eficiencia e integración ligera.Las pistas de XC modernas exigen cada día más capacidad .</p>
          <p class="precio">$59,360.00 <span>(Impuesto incluido)</span></p>
          <p class="precio">
            🚨Última unidad🚨  
...
<form action="Carrito.jsp" method="post">
  ...
  <input type="hidden" name="imagen" value="images/swor.jpg">
