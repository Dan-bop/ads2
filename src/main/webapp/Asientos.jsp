  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized /  <span>Asientos</span>
        </h4>
      </div>
<br>

      <div class="banner">
        <img class="banner" src="images/bannerasientos.jpg">
      </div>
...
<div class="banner-contenedor">
    <div class="banner-centered">
        <img src="images/Power Expert con Mirror.jpg" alt="Power Expert con Mirror" title="Power Expert con Mirror">
        <div class="descripcion-banner">
            <h2>Power Expert con Mirror</h2>
            <p class="precio">$ 745.00</p>
            <P> <span class="stars">★★★★</span></P>
          <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Power Expert con Mirror">
  <input type="hidden" name="imagen" value="images/Power Expert con Mirror.jpg">
  <input type="hidden" name="precio" value="745.00">
   <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Asiento">
  ...
  <center>
   ...
   <div class="banner-centered">
        <img src="images/Power Comp with MIMIC.jpg" alt="Power Comp with MIMIC" title="Power Comp with MIMIC">
        <div class="descripcion-banner">
            <h2>Power Comp with MIMIC</h2>
            <p class="precio">$ 520.00</p>
            <P> <span class="stars">★★★★</span></P>
                  <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Power Comp with MIMIC">
  <input type="hidden" name="imagen" value="images/Power Comp with MIMIC.jpg">
  ...
  <center>
   ...
   <div class="banner-centered">
        <img src="images/Phenom Comp with MIMIC.jpg" alt="Phenom Comp with MIMIC" title="Phenom Comp with MIMIC">
        <div class="descripcion-banner">
            <h2>Phenom Comp with MIMIC</h2>
            <p class="precio">$ 520.00</p>
            <P> <span class="stars">★★★★</span></P>
                              <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Phenom Comp with MIMIC">
  <input type="hidden" name="imagen" value="images/Phenom Comp with MIMIC.jpg">
  <input type="hidden" name="precio" value="520.00">
  <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Asiento">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
   ...
   <div class="banner-centered">
        <img src="images/Phenom Comp.jpg" alt="Phenom Comp" title="Phenom Comp">
        <div class="descripcion-banner">
            <h2>Phenom Comp</h2>
            <p class="precio">$ 520.00</p>
            <P> <span class="stars">★★★★</span></P><br>
                                        <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Phenom Comp">
  <input type="hidden" name="imagen" value="images/Phenom Comp.jpg">
  <input type="hidden" name="precio" value="520.00">
  <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Asiento">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
   ...
   <div class="banner-centered">
        <img src="images/Expedition Gel.jpg" alt="Expedition Gel" title="Expedition Gel">
        <div class="descripcion-banner">
            <h2>Expedition Gel</h2>
            <p class="precio">$ 190.00</p>
            <P> <span class="stars">★★★★</span></P><br>
                                      <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Expedition Gel">
  <input type="hidden" name="imagen" value="images/Expedition Gel.jpg">
  ...
  <div class="banner-centered">
        <img src="images/Body Geometry Comfort Gel.jpg" alt="Body Geometry Comfort Gel" title="Body Geometry Comfort Gel">
        <div class="descripcion-banner">
            <h2>Body Geometry Comfort Gel</h2>
            <p class="precio">$ 190.00</p>
            <P> <span class="stars">★★★★</span></P>
                                         <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Body Geometry Comfort Gel">
  <input type="hidden" name="imagen" value="images/Body Geometry Comfort Gel.jpg">
  <input type="hidden" name="precio" value="190.00">
  <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Asiento">
  <input type="hidden" name="cantidad" value="1">
