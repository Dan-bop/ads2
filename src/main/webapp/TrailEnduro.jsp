  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS / <span>Trail Enduro</span>
        </h4>
      </div>
<br>

      <div class="banner">
        <img class="banner" src="images/bannerTrailendurro.jpg">
      </div>
...
<div class="banner-contenedor">
    <div class="banner-centered">
        <img src="images/Stumpjumper 15 Öhlins Coil.jpg" alt="Stumpjumper 15 Öhlins Coil" title="Stumpjumper 15 Öhlins Coil">
             <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Stumpjumper 15 Öhlins Coil</h2>
            <p class="precio">$33,360.00 </p>
                <P> <span class="stars">★★★★</span></P>
             <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Stumpjumper 15 Öhlins Coil">
  <input type="hidden" name="imagen" value="images/Stumpjumper 15 Öhlins Coil.jpg">
  <input type="hidden" name="precio" value="33,360.00">
   <input type="hidden" name="talla" value="M">
   <input type="hidden" name="producto" value="Bicicleta MTB 15 Öhlins">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/img16.jpg" alt="S-WORKS World CUP" title="S-WORKS World CUP">
            <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>S-WORKS World CUP</h2>
            <p class="precio">$51,940.00 </p>
            <P> <span class="stars">★★★★★</span></P><br><br>
           <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="S-WORKS World CUP">
  <input type="hidden" name="imagen" value="images/img16.jpg" >
  <input type="hidden" name="precio" value="51,940.00  ">
   <input type="hidden" name="talla" value="M">
    <input type="hidden" name="producto" value="Bicicleta MTB CUP">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    ...
    <div class="banner-centered">
         <img src="images/img18.jpg" alt="Paginas S-Works" title="S-Works Epic Hardtail">
             <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>S-Works Epic Hardtail</h2>
            <p class="precio">$40,810.00 </p>
            <P> <span class="stars">★★★★★</span></P><br>
                    
         <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="S-Works Epic Hardtail">
  <input type="hidden" name="imagen" value="images/img18.jpg" >
  <input type="hidden" name="precio" value="40,810.00  ">
   <input type="hidden" name="talla" value="L">
    <input type="hidden" name="producto" value="Bicicleta MTB 15 Hardtail">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    ...
    <div class="banner-centered">
         <img src="images/img19.jpg" alt="S-Works Stumpjumper EVO" title="S-Works Stumpjumper EVO">
             <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>S-Works Stumpjumper EVO</h2>
            <p class="precio">$20,922.00 </p>
                <P> <span class="stars">★★★★</span></P>
         <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="S-Works Stumpjumper EVO">
  <input type="hidden" name="imagen" value="images/img19.jpg">
  <input type="hidden" name="precio" value="20,922.00 ">
   <input type="hidden" name="talla" value="L">
    <input type="hidden" name="producto" value="Bicicleta MTB 15 EVO">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    <button type="submit">Agregar<span></span></button>
      ...
      <div class="banner-centered">
         <img src="images/Stumpjumper 15 Expert.jpg" alt="Stumpjumper 15 Expert" title="Stumpjumper 15 Expert">
             <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Stumpjumper 15 Expert</h2>
            <p class="precio">$ 26,900.00 </p>
                <p> <span class="stars">★★★★★</span></p>
           <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Stumpjumper 15 Expert">
  <input type="hidden" name="imagen" value="images/Stumpjumper 15 Expert.jpg" >
  <input type="hidden" name="precio" value="26,900.00 ">
   <input type="hidden" name="talla" value="L">
    <input type="hidden" name="producto" value="Bicicleta MTB EXPERT">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    <button type="submit">Agregar<span></span></button>
      ...
      <div class="banner-centered">
         <img src="images/Status 170 2.jpg" alt="Status 170 2" title="Status 170 2">
             <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Status 170 2</h2>
            <p class="precio">$14,840.00 </p>
                <p> <span class="stars">★★★★★</span></p>  <br><br>
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Status 170 2">
  <input type="hidden" name="imagen" value="images/Status 170 2.jpg" >
  <input type="hidden" name="precio" value="14,840.00 ">
   <input type="hidden" name="talla" value="M">
    <input type="hidden" name="producto" value="Bicicleta MTB 170">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    <button type="submit">Agregar<span></span></button>
      ...
      <div class="banner-centered">
         <img src="images/Stumpjumper EVO Expert.jpg" alt="Stumpjumper EVO Expert" title="Stumpjumper EVO Expert">
             <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Stumpjumper EVO Expert</h2>
            <p class="precio">$25,970.00 </p>
                <P> <span class="stars">★★★★★</span></P>
          <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Stumpjumper EVO Expert">
  <input type="hidden" name="imagen" value="images/Stumpjumper EVO Expert.jpg" >
  <input type="hidden" name="precio" value="25,970.00 ">
   <input type="hidden" name="talla" value="M">
    <input type="hidden" name="producto" value="Bicicleta MTB Expert">
  <input type="hidden" name="cantidad" value="1">
  ...
  <div class="banner-centered">
         <img src="images/Stumpjumper Comp.jpg" alt="Stumpjumper Comp" title="Stumpjumper Comp">
             <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Stumpjumper Comp</h2>
            <p class="precio">$12,468.00 </p>
                <p> <span class="stars">★★★★★</span></p>   <br>
    <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Stumpjumper Comp">
  <input type="hidden" name="imagen" value="images/Stumpjumper Comp.jpg" >
  <input type="hidden" name="precio" value="12,468.00">
   <input type="hidden" name="talla" value="M">
    <input type="hidden" name="producto" value="Bicicleta MTB Comp">
  <input type="hidden" name="cantidad" value="1">
