...
<head>
    ...
    <title>Pestaña Porta Botella</title>
  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized /  <span>Porta Botella</span>
        </h4>
      </div>
<br>

      <div class="banner">
        <img class="banner" src="images/bannerportabotella.jpg">
      </div>
...
<div class="banner-contenedor">
    <div class="banner-centered">
        <img src="images/Zee Cage II with Tool – Right.jpg" alt="Zee Cage II with Tool – Right" title="Zee Cage II with Tool – Right">
        <div class="descripcion-banner">
            <h2>Zee Cage II with Tool – Right</h2>
            <p class="precio">$ 190.00 </p>
            <P> <span class="stars">★★★★</span></P>
               <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Zee Cage II with Tool – Right">
  <input type="hidden" name="imagen" value="images/Zee Cage II with Tool – Right.jpg">
  <input type="hidden" name="precio" value="190.00">
  <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Porta Botella">
...
<div class="banner-centered">
        <img src="images/Zee Cage II – Derecha.jpg" alt="Zee Cage II – Derecha" title="Zee Cage II – Derecha">
        <div class="descripcion-banner">
            <h2>Zee Cage II – Derecha</h2>
            <p class="precio">$  95.00 </p>
            <P> <span class="stars">★★★★</span></P><br>
          <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Zee Cage II – Derecha">
  <input type="hidden" name="imagen" value="images/Zee Cage II – Derecha.jpg">
...
<div class="banner-centered">
        <img src="images/Zee Cage II - Izquierda.jpg" alt="Zee Cage II - Izquierda" title="Zee Cage II - Izquierda">
        <div class="descripcion-banner">
            <h2>Zee Cage II - Izquierda </h2>
            <p class="precio">$  95.00 </p>
            <P> <span class="stars">★★★★</span></P>
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Zee Cage II - Izquierda">
  <input type="hidden" name="imagen" value="images/Zee Cage II - Izquierda.jpg">
  <input type="hidden" name="precio" value="95.00 ">
  <input type="hidden" name="talla" value="Unique">
     <input type="hidden" name="producto" value="Porta Botella">
  <input type="hidden" name="cantidad" value="1">
...
<div class="banner-centered">
        <img src="images/Rib Cage II.jpg" alt="Rib Cage II" title="Rib Cage II">
        <div class="descripcion-banner">
            <h2>Rib Cage II</h2>
            <p class="precio">$ 76.00 </p>
            <P> <span class="stars">★★★★</span></P><br>
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Rib Cage II">
  <input type="hidden" name="imagen" value="images/Rib Cage II.jpg">
  <input type="hidden" name="precio" value="76.00 ">
  <input type="hidden" name="talla" value="Unique">
     <input type="hidden" name="producto" value="Porta Botella">
  <input type="hidden" name="cantidad" value="1">
...
<div class="banner-centered">
        <img src="images/Roll Cage.jpg" alt="Roll Cage" title="Roll Cage">
        <div class="descripcion-banner">
            <h2>Rib Cage </h2>
            <p class="precio">$ 48.00 </p>
            <P> <span class="stars">★★★★</span></P>
              <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Rib Cage">
  <input type="hidden" name="imagen" value="images/Roll Cage.jpg">
...
<div class="banner-centered">
        <img src="images/Rib Cage IIcolor.jpg" alt="Rib Cage II" title="Rib Cage II">
        <div class="descripcion-banner">
            <h2>Rib Cage II </h2>
            <p class="precio">$ 76.00 </p>
            <P> <span class="stars">★★★★</span></P>
            <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Rib Cage II">
  <input type="hidden" name="imagen" value="images/Rib Cage IIcolor.jpg">
  <input type="hidden" name="precio" value="76.00">
   <input type="hidden" name="talla" value="Unique">
      <input type="hidden" name="producto" value="Porta Botella">
  <input type="hidden" name="cantidad" value="1">
