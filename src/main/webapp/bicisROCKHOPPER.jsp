  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS / <span>ROCKHOPPER</span>
        </h4>
      </div>
<br>

      <div class="banner">
        <img class="banner" src="images/bannerrock.jpg">
      </div>
...
<h2 style="text-align: center; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; 
            font-size: 2.5em; color: #2c3e50; text-shadow: 1px 1px 3px rgba(0,0,0,0.2); 
            margin-top: 40px;">
  🚴‍♂️ Bicicletas Rockhopper 🚴‍♀️
</h2>
...
<div class="banner-contenedor">
    <div class="banner-centered">
        <img src="images/Rockhopper Expert 29.jpg" alt="Rockhopper Expert 29" title="Rockhopper Expert 29">
           <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Rockhopper Expert 29</h2>
            <p class="precio">$5,010.00 </p>
                <P> <span class="stars">★★★★</span></P>
         <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Rockhopper Expert 29">
  <input type="hidden" name="imagen" value="images/Rockhopper Expert 29.jpg">
  <input type="hidden" name="precio" value="5,010.00">
...
<div class="banner-centered">
        <img src="images/Rockhopper Sport 29.jpg" alt="Rockhopper Sport 29.jpg" title="Rockhopper Sport 29.jpg">
           <div class="etiqueta-talla">M</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Rockhopper Sport 29</h2>
            <p class="precio">$2,970.00 </p>
                <p> <span class="stars">★★★★</span></p>  <br><br>
                   <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Rockhopper Sport 29">
  <input type="hidden" name="imagen" value="images/Rockhopper Sport 29.jpg">
  <input type="hidden" name="precio" value="2,970.00">
   <input type="hidden" name="talla" value="M">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  <input type="hidden" name="cantidad" value="1">
...
<div class="banner-centered">
        <img src="images/Rockhopper Sport 29blanco.jpg" alt="Rockhopper Sport 29.jpg" title="Rockhopper Sport 29.jpg">
        ...
        <div class="descripcion-banner">
            ...
            <p class="precio">$2,970.00 </p>
                <P> <span class="stars">★★★★</span></P>  <br><br>
                           <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Rockhopper Sport 29">
  <input type="hidden" name="imagen" value="images/Rockhopper Sport 29blanco.jpg" >
  <input type="hidden" name="precio" value="2,970.00">
...
<div class="banner-centered">
        <img src="images/Rockhopper 29.jpg" alt="Rockhopper 29" title="Rockhopper 29">
           <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Rockhopper 29</h2>
            <p class="precio">$ 1,784.00 </p>
                <P> <span class="stars">★★★★</span></P><br>
                                    <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Rockhopper  29">
  <input type="hidden" name="imagen" value="images/Rockhopper 29.jpg">
  <input type="hidden" name="precio" value=" 1,784.00">
   <input type="hidden" name="talla" value="L">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  <input type="hidden" name="cantidad" value="1">
...
<div class="banner-centered">
        <img src="images/Rockhopper Expert 29verde.jpg" alt="Rockhopper Sport 29" title="Rockhopper Sport 29">
           <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
        <div class="descripcion-banner">
            <h2>Rockhopper Sport 29</h2>
            <p class="precio">$ 5,010.00 </p>
                <p> <span class="stars">★★★★</span></p>
                                              <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Rockhopper Sport  29">
  <input type="hidden" name="imagen" value="images/Rockhopper Expert 29verde.jpg">
  <input type="hidden" name="precio" value=" 5,010.00">
   <input type="hidden" name="talla" value="L">
   <input type="hidden" name="producto" value="Bicicleta MTB">
  <input type="hidden" name="cantidad" value="1">
