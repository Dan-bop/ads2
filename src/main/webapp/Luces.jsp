  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized /  <span>Luces</span>
        </h4>
      </div>
<br>

      <div class="banner">
        <img class="banner" src="images/bannerluces.jpg">
      </div>
...
<div class="banner-contenedor">
    <div class="banner-centered">
        <img src="images/Stix Elite 2 Frontal.jpg" alt="Stix Elite 2 Frontal" title="Stix Elite 2 Frontal">
        <div class="descripcion-banner">
            <h2>Stix Elite 2 Frontal</h2>
            <p class="precio">$ 190.00 </p>
            <P> <span class="stars">★★★★</span></P>
            
                         <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Stix Elite 2 Frontal">
  <input type="hidden" name="imagen" value="images/Stix Elite 2 Frontal.jpg">
  <input type="hidden" name="precio" value="190.00">
   <input type="hidden" name="talla" value="Unique">
   <input type="hidden" name="producto" value="Luces">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Flash 300 Headlight.jpg" alt="Flash 300 Headlight" title="Flash 300 Headlight">
        <div class="descripcion-banner">
            <h2>Flash 300 Headlight</h2>
            <p class="precio">$ 152.00 </p>
            <P> <span class="stars">★★★★</span></P>
         
                                  <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Flash 300 Headlight">
  <input type="hidden" name="imagen" value="images/Flash 300 Headlight.jpg">
  <input type="hidden" name="precio" value="152.00 s">
   <input type="hidden" name="talla" value="Unique">
   <input type="hidden" name="producto" value="Luces">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/flux.jpg" alt="Flux™ 900/1200 Headlight Handle Bar Mount" title="Flux™ 900/1200 Headlight Handle Bar Mount">
        <div class="descripcion-banner">
            <h2>Flux™ 900/1200  Handle  </h2>
            <p class="precio">$ 95.00</p>
            <P> <span class="stars">★★★★</span></P>
                              <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Flux™ 900/1200  Handle">
  <input type="hidden" name="imagen" value="images/flux.jpg">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/fluxcasco.jpg" alt="Flux™ 900/1200 Headlight Handle Bar Mount" title="Flux™ 900/1200 Headlight Handle Bar Mount">
        <div class="descripcion-banner">
            <h2>Flux™ 900/1200  Helmet  </h2>
            <p class="precio">$ 60.00</p>
            <P> <span class="stars">★★★★</span></P>
                                 <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Flux™ 900/1200  Helmet">
  <input type="hidden" name="imagen" value="images/fluxcasco.jpg">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="images/Flash Pack HeadlightTaillight Combo.jpg" alt="Flash Pack Headlight/Taillight Combo" title="Flash Pack Headlight/Taillight Combo">
        <div class="descripcion-banner">
            <h2>Flash Pack Headlight/Taillight Combo  </h2>
            <p class="precio">$  245.00</p>
            <P> <span class="stars">★★★★</span></P>
                               <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Flash Pack Headlight/Taillight Combo ">
  <input type="hidden" name="imagen" value="images/Flash Pack HeadlightTaillight Combo.jpg">
  <input type="hidden" name="precio" value="245.00">
   <input type="hidden" name="talla" value="Unique">
   <input type="hidden" name="producto" value="Luces">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
    ...
    <div class="banner-centered">
        <img src="../images/Combinación Flash FrontalTrasera.jpg" alt="Combinación Flash Frontal/Trasera" title="Combinación Flash Frontal/Trasera">
        <div class="descripcion-banner">
            <h2>Combinación Flash Frontal/Trasera</h2>
