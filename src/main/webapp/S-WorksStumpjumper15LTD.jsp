  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS /  <span>S-Works Stumpjumper 15 LTD</span>
        </h4>
      </div>
      <br><br>
      ...
      <div class="banner-contenedor">
        <div class="banner-centered">
            <img src="images/img15.jpg" alt="Paginas S-Works" title="S-Works Stumpjumper 15 LTD">
            <div class="etiqueta-talla">L</div> <!-- Talla M como etiqueta -->
          </div>
        <div class="descripcion-banner">
          <h2>S-Works Stumpjumper 15 LTD</h2>
          <p>La S-Works Stumpjumper 15 LTD esta disenada para que no tengas que hacer ninguna concesion mientras montas por los senderos. Te presentamos la nueva S-Works Stumpjumper LTD con suspension FOX Live Valve Neo.</p>
          <p class="precio">$53,795.00 <span>(Impuesto incluido)</span></p>
          <p class="precio">
            🚨Última unidad🚨  
...
<form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="S-Works Stumpjumper 15 LTD">
  <input type="hidden" name="imagen" value="images/img15.jpg">
  <input type="hidden" name="precio" value="53,795.00">
   <input type="hidden" name="talla" value="L">
   <input type="hidden" name="producto" value="Bicicleta MTB Stumpjumper LDT">
