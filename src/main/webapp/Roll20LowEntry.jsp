...
<head>
    ...
    <title>S-Works Stumpjumper 15 LTD</title>
...
<div class="nav-icons">
  <div class="user-menu">
    <a href="#"><i class="bi bi-person"></i> ${sessionScope.nombre} ${sessionScope.apellido}</a>
  ...
  <a href="#"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS /  <span>Roll 2.0 Low Entry</span>
        </h4>
      </div>
      <br><br>
      ...
      <div class="banner-contenedor">
        <div class="banner-centered">
            <img src="images/Roll 2.0 Low Entry.jpg" alt="Roll 2.0 Low Entry" title="Roll 2.0 Low Entry">
            <div class="etiqueta-talla">XS</div> <!-- Talla M como etiqueta -->
          </div>
        <div class="descripcion-banner">
          <h2>Roll 2.0 Low Entry</h2>
          <p>Roll 2.0 Low Entry esta disenada para que no tengas que hacer ninguna concesion mientras montas por los senderos o salir a pasear por los hermoso paisajes de la cuidad.</p>
          <p class="precio">$2,525.00 <span>(Impuesto incluido)</span></p>
          <p class="precio">
            🚨Última unidad🚨  
...
<form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Roll 2.0 Low Entry">
  <input type="hidden" name="imagen" value="images/Roll 2.0 Low Entry.jpg">
  <input type="hidden" name="precio" value="2,525.00">
