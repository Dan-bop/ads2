...
<head>
    ...
    <title>S-Works Epic Hardtail</title>
  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized / S-WORKS /  <span>S-Works Epic Hardtail</span>
        </h4>
      </div>
      <br><br>
      ...
      <div class="banner-contenedor">
        ...
        <div class="descripcion-banner">
          ...
          <p> Epic Hardtail, ridiculamente eficaz, asombrosamente comoda; increiblemente ligera y rapida en cualquier terreno. Sin duda, mejoramos cada centimetro del cuadro Epic Hardtail para lograr el cuadro rigido de serie mas ligero del mundo, pero tambien priorizamos nuestro compromiso de crear una Epic Hardtail que sea tan eficaz como comoda; con una geometria agresiva inspirada en los senderos, con mayor paso de rueda y un cuadro disenado con obsesion para obtener mayor absorcion.</p>
          <p class="precio">$40,810.00 <span>(Impuesto incluido)</span></p>
...
<form action="Carrito.jsp" method="post">
  ...
  <input type="hidden" name="precio" value="40,810.00">
   ...
   <input type="hidden" name="producto" value="Bicicleta MTB Hardtail">
