  ...
  <a href="Carrito.jsp"><i class="bi bi-cart3"></i></a>
    ...
    <div class="breadcrumb-container">
        <h4 class="breadcrumb-title" id="breadcrumb">
          Inicio / Specialized /  <span>Aros</span>
        </h4>
      </div>
<br>

      <div class="banner">
        <img class="banner" src="images/banneraros.jpg">
      </div>
...
<div class="banner-contenedor">
    <div class="banner-centered">
        <img src="images/Roval Control SL 29 6B XD Wheelset.jpg" alt="Roval Control SL 29 6B XD Wheelset" title="Roval Control SL 29 6B XD Wheelset">
        <div class="descripcion-banner">
            <h2>Roval Control SL 29 6B XD Wheelset</h2>
            <p class="precio">$9,275.00 </p>
            <P> <span class="stars">★★★★</span></P>
      <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Roval Control SL 29 6B XD Wheelset">
  <input type="hidden" name="imagen" value="images/Roval Control SL 29 6B XD Wheelset.jpg">
  <input type="hidden" name="precio" value="9,275.00">
    <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Aros">
  ...
  <center>
   ...
   <div class="banner-centered">
        <img src="images/Roval Traverse SL II 240 6B.jpg" alt="Roval Traverse SL II 240 6B" title="Roval Traverse SL II 240 6B">
        <div class="descripcion-banner">
            <h2>Roval Traverse SL II 240 6B</h2>
            <p class="precio">$ 3,435.00 </p>
            <P> <span class="stars">★★★★</span></P>
         <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Roval Traverse SL II 240 6B">
  <input type="hidden" name="imagen" value="images/Roval Traverse SL II 240 6B.jpg">
  <input type="hidden" name="precio" value="3,435.00">
    <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Aros">
  <input type="hidden" name="cantidad" value="1">
  ...
  <center>
   ...
   <div class="banner-centered">
        <img src="images/Roval Traverse SL II 350 6B.jpg" alt="Roval Traverse SL II 350 6B" title="Roval Traverse SL II 350 6B">
        <div class="descripcion-banner">
            <h2>Roval Traverse SL II 350 6B</h2>
            <p class="precio">$  2,415.00</p>
            <P> <span class="stars">★★★★</span></P>
                    <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Roval Traverse SL II 350 6B">
  <input type="hidden" name="imagen" value="images/Roval Traverse SL II 350 6B.jpg">
  <input type="hidden" name="precio" value="2,415.00">
    <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Aros">
  <input type="hidden" name="cantidad" value="1">
  ...
  <div class="banner-centered">
        <img src="images/Cockpit Roval Rapide.jpg" alt="Cockpit Roval Rapide" title="Cockpit Roval Rapide">
        <div class="descripcion-banner">
            <h2>Cockpit Roval Rapide</h2>
            <p class="precio">$ 2,230.00 </p>
            <P> <span class="stars">★★★★</span></P><br>
                             <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Cockpit Roval Rapide">
  <input type="hidden" name="imagen" value="images/Cockpit Roval Rapide.jpg" >
  <input type="hidden" name="precio" value="2,230.00">
  <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Aros">
  <input type="hidden" name="cantidad" value="1">
  ...
  <div class="banner-centered">
        <img src="images/Stout XC SL 29 Rear.jpg" alt="Stout XC SL 29 Rear" title="Stout XC SL 29 Rear">
        <div class="descripcion-banner">
            <h2>Stout XC SL 29 Rear</h2>
            <p class="precio">$  520.00 </p>
            <P> <span class="stars">★★★★</span></P><br>
                                      <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Stout XC SL 29 Rear">
  <input type="hidden" name="imagen" value="images/Stout XC SL 29 Rear.jpg" >
  <input type="hidden" name="precio" value=" 520.00">
   <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Aros">
  <input type="hidden" name="cantidad" value="1">
  ...
  <div class="banner-centered">
        <img src="images/Stout XC SL 29 Front.jpg" alt="Stout XC SL 29 Front" title="Stout XC SL 29 Front">
        <div class="descripcion-banner">
            <h2>Stout XC SL 29 Front</h2>
            <p class="precio">$  435.00 </p>
            <P> <span class="stars">★★★★</span></P><br>
  <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Stout XC SL 29 Front">
  <input type="hidden" name="imagen" value="images/Stout XC SL 29 Front.jpg" >
  <input type="hidden" name="precio" value=" 435.00">
   <input type="hidden" name="talla" value="Unique">
    <input type="hidden" name="producto" value="Aros">
  <input type="hidden" name="cantidad" value="1">
  ...
  <div class="banner-centered">
        <img src="images/Standard Schrader Valve Tube.jpg" alt="Standard Schrader Valve Tube" title="Standard Schrader Valve Tube">
        <div class="descripcion-banner">
            <h2>Standard Schrader Valve Tube</h2>
                  <div class="etiqueta-talla">27.5</div> <!-- Talla M como etiqueta -->
            <p class="precio">$  40.00 </p>
            <P> <span class="stars">★★★★</span></P>
             <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="Standard Schrader Valve Tube">
  <input type="hidden" name="imagen" value="images/Standard Schrader Valve Tube.jpg">
 ...
 <div class="banner-centered">
        <img src="images/2Bliss Ready Rim Strip.jpg" alt="2Bliss Ready Rim Strip" title="2Bliss Ready Rim Strip">
        <div class="descripcion-banner">
            <h2>2Bliss Ready Rim Strip</h2>
            <p class="precio">$  20.00 </p>
            <P> <span class="stars">★★★★</span></P>
                     <form action="Carrito.jsp" method="post">
  <input type="hidden" name="nombre" value="2Bliss Ready Rim Strip">
  <input type="hidden" name="imagen" value="images/2Bliss Ready Rim Strip.jpg">
